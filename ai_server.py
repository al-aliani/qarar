...
أهم النقاط:
1. موقع استراتيجي في {city}.
2. فريق عمل محترف ذو خبرة.
3. خطة مالية طموحة تستهدف استرداد رأس المال خلال 3 سنوات.

نحن نؤمن بأن هذا المشروع يمثل فرصة استثمارية واعدة نظراً للنمو المتزايد في القطاع والطلب المستمر.
"""
...
"""
             ...
             return {
                "strengths": [f"موقع متميز في {city}", "فريق عمل ذو خبرة عالية", "تكنولوجيا حديثة", "تكاليف تشغيلية منخفضة"],
                "weaknesses": ["علامة تجارية جديدة", "ميزانية تسويق محدودة"],
                "opportunities": ["الطلب المتزايد في السوق", "التوسع لفروع جديدة", "شراكات استراتيجية"],
