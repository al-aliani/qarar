...
export const PRICING_COMPARISON = Object.freeze({
    free: { limit: 'إنشاء وحفظ دراسة أولية', unlock: 'تفسير المؤشرات والتصدير الاحترافي ومراجعة الخبير', includes: ['إدخال البيانات الأساسية', 'حفظ التقدم', 'استكشاف مسار الدراسة'] },
