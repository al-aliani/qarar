...
const DOCUMENTED_BACKDATED_ALLOWLIST = new Set([
    ...
    // استثناء تصميمي ثانٍ من نفس الفئة بالضبط (2026-08-29): ترحيل تأسيس جدول
    // public.study_shares — يجب أن يُطبَّق قبل 20260714020000_share_tokens.sql
    // (أول ترحيل مُتتبَّع يمسّ هذا الجدول عبر ALTER TABLE بافتراض وجوده) رغم
    // إدخاله للمستودع متأخراً عمداً اليوم. انظر تعليق أعلى الملف
    // 20260714015000_study_shares_table_bootstrap.sql نفسه لتفاصيل السبب.
    '20260714015000_study_shares_table_bootstrap.sql',
