...
const STEP_HELP_SOURCE = [
  ...
  { why: 'إيجار موقع المشروع عادة أكبر بند تكلفة ثابتة شهرية — بالإضافة للكهرباء والاتصالات والمصاريف الإدارية الأخرى.', how: 'ابدأ بإيجار المقر الشهري، ثم أضف الكهرباء والاتصالات وبقية البنود الإدارية.' },
  ...
  { why: 'لوحة القرار تعطيك التوصية النهائية (مجدي/يحتاج مراجعة/غير مجدي) ومؤشرات القرار.', how: 'راجع التوصية والمؤشرات واقرأ "لماذا" و"الخطوات التالية".' },
