...
const SECTION_PHASE_LABELS = {
  ...
  marketing: { phase: 'تسويقية', label: 'المرحلة التسويقية' },
  financial: { phase: 'مالية', label: 'المرحلة المالية' },
  strategic: { phase: 'استراتيجية', label: 'التحليل الاستراتيجي والمخاطر' },
...
export const STEP_HELP = [
  ...
  { why: 'التحليل الاستراتيجي يحوّل نقاط القوة والضعف إلى قرارات عملية قبل الالتزام.', how: 'راجع الخلاصة الاستراتيجية المبنية على SWOT وحدّث ما تغيّر.' },
