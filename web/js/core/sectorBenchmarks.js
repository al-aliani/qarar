...
export const SECTOR_BENCHMARKS = {
    ...
    service: {
        label: 'خدمي',
        // تدقيق 2026-09-04 (رحلة عميل صالون حقيقية): مُعرَّف قبل retailHighMargin عمداً.
        // «صالون / مركز تجميل» — وهو خيار حرفي في قائمة الأنشطة (fieldOptions.js) — كان
        // يطابق /تجميل/ في retailHighMargin أولاً فيُصنَّف محل عطور: عمالة 10-22% بدل
        // 30-50%، فينصح المستشار صاحب صالون كثيف العمالة بـ«قلّل عدد الموظفين».
        // و«مغسلة ملابس» كانت تُخطف عبر /ملابس/ فتأخذ أدنى معيار استهلاك مياه في الجدول.
        // النطاق هنا لا يطابق «عطور/مستحضرات تجميل» فمحلات التجميل التجزئية تبقى سليمة.
        // ملاحظة: «سبا» أُسقط عمداً — يطابق «المناسبات» كنص فرعي (م-ن-ا-<سبا>-ت)
        // فيصنّف نشاطاً فنياً على أنه خدمي. الصالونات مغطّاة بـصالون/حلاق/مشغل.
        test: /خدمي|استشار|تعليم|تدريب|صحي|عيادة|رياضة|لياقة|نادي|صالة|صالون|حلاق|مشغل|مغسلة|غسيل|صيانة|تنظيف/i,
