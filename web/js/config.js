...
export const REFUND_POLICY = {
    ...
    /** النص الكامل */
    fullText: `إذا لم تُرضِك جودة الدراسة أو المراجعة أو الخدمة خلال ${15} يوماً، يمكنك طلب استرداد المبلغ المدفوع وفق سياسة الاسترجاع المنشورة (refund-policy.html).

الشروط:
• يُطبَّق على جميع الباقات المدفوعة (إن وُجدت).
• تبدأ مدة الـ${15} يوماً من تاريخ الدفع في الباقة الذاتية، ومن تاريخ التسليم الفعلي في باقتَي المراجعة بخبير والخدمة الكاملة.
• في الباقة الذاتية يلزم أن يكون سبب الطلب متعلقاً بجودة المحرك أو دقة حساباته.
