...
/**
 * بيانات المنشأة النظامية — تُستخدم في الفاتورة الضريبية (ZATCA) وهوية التاجر في التذييل.
 * ⚠️ قبل الإطلاق: املأ الرقم الضريبي والسجل التجاري والعنوان (مطلب نظامي لبيع خاضع للضريبة
 * في السعودية). حتى تُملأ، تُظهر الفاتورة تنبيهاً بأن الرقم الضريبي غير مُدخَل. مكان واحد فقط.
 */
export const MERCHANT_INFO = {
    name: 'مؤسسة بن صاحب التجارية',
    vatNumber: '', // الرقم الضريبي (15 خانة) — إلزامي للفاتورة الضريبية
    crNumber: '',  // رقم السجل التجاري
    address: '',   // العنوان الوطني
    email: 'bin.sahib.est@gmail.com'
};
