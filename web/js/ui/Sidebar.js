...
export class Sidebar {
    ...
    getStepIcon(index) {
        const icons = [
            '🔍', // 0: Preliminary
            '⚖️', // 1: Project Alternatives
            '🚀', // 2: Templates
            '🏠', '🎯', // 3-4: Project Info, Smart Goals
            '🏗️', '👥', '💻', '🚚', '📂', '🏢', '🏭', '⚖️', // 3-10: Technical...Legal
            '📈', '📢', '💰', '🛠️', // 11-14: Market...Services
            '🏦', '🤝', '📝', '📊', '📅', '⚖️', '📉', '💹', // 15-22: Financing...Financial Eval
            '🧩', '⚠️', '⛈️', '🔍', '🔮',  // 23-27: Strategic, Risk, Stress, Sensitivity, Scenarios
            '📅', // 28: Timeline
            '🌙', // 29: Zakat
            '🎲', '💎', // 30-31: Monte Carlo, Valuation
            '🔭', // 32: Actuals
            '💼', // 33: نموذج العمل (Business Model)
            '🚦', '🏁', '🖥️' // 34-36: Decision, Exec, Dashboard
        ];
        return icons[index] || '🔹';
    }
