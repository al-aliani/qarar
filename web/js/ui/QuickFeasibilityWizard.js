    ...
    renderStep3() {
        ...
        this.container.innerHTML = `
            <div class="quick-feasibility animate-entry" dir="rtl">
                ...
                <p class="text-xs text-muted mt-2 max-w-xl">«استكمال الدراسة الكاملة» ينشئ دراسة تفصيلية جديدة (42 خطوة مرنة وقابلة للتخطي) تبدأ باسم مشروعك وبياناتك الحالية كنقطة انطلاق — منفصلة عن هذه المسودة السريعة.</p>
