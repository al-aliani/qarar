...
const STUDY_MODES = [
    { id: 'mini', icon: 'bolt', name: 'مصغّر (للمبتدئين)', desc: `المشروع، التكاليف، الفريق، الإيرادات، التمويل، القرار — أقل الأسئلة لمسودة أولية سريعة تختبر فكرتك (${modeStepCount('mini')} خطوات تقريباً). لا تشمل تحليل السوق أو المخاطر أو الجوانب القانونية، وليست دراسة جاهزة للتمويل.`, badge: 'نقطة بداية جيدة' },
...
export class TemplateGallery {
    ...
    getTemplates() {
        return [
            ...
            {
                // تدقيق 2026-09-04 (رحلة عميل صالون حلاقة): القوالب الأربعة السابقة
                // (مطعم/تطبيق/تجزئة/مكتب خدمات) لا تغطي أي نشاط عناية شخصية. أقربها
                // اسماً «مكتب خدمات» وهو ترخيص مهني وأثاث مكتبي وأجهزة حاسب — مضلل
                // فعلياً لصالون يحتاج كراسي حلاقة ومغاسل ومعقّمات وسخانات مياه.
                // فكان العميل إما يبدأ بأرقام لا تخصّه أو يبدأ من الصفر.
                // الأرقام إرشادية (ASSUMPTION) كبقية القوالب هنا، ومصاغة لصالون
                // متوسط في الرياض بمساحة ~150–180 م² وستة كراسي.
                id: 'personal_care',
                name: 'صالون / مركز عناية',
                description: 'يبدأ بكراسي الحلاقة والمغاسل والمعقّمات وسخانات المياه والترخيص البلدي والصحي — أرقام إرشادية تُعدّلها ببياناتك.',
                icon: 'i-users',
                data: {
                    projectInfo: { sector: 'الخدمات الشخصية والعناية', concept: 'صالون / مركز تجميل' },
                    legal: {
                        licenses: [
                            { name: 'سجل تجاري', price: 1200, quantity: 1 },
                            { name: 'رخصة البلدية (محل عناية شخصية)', price: 2500, quantity: 1 },
                            { name: 'شهادات صحية للعاملين', price: 1500, quantity: 1 },
                            { name: 'شهادة الدفاع المدني', price: 1000, quantity: 1 }
                        ]
                    },
                    technical: {
                        equipment: [
                            { name: 'كراسي حلاقة احترافية', price: 3500, quantity: 6 },
                            { name: 'مغاسل شعر', price: 2500, quantity: 3 },
                            { name: 'مرايا ووحدات تخزين', price: 1800, quantity: 6 },
                            { name: 'أدوات ومكائن ومعقّمات', price: 15000, quantity: 1 },
                            { name: 'سخانات وسباكة مياه', price: 8000, quantity: 1 },
                            { name: 'ديكور وتشطيب داخلي', price: 120000, quantity: 1 }
                        ]
                    },
                    hr: {
                        positions: [
                            { position: 'مدير/مديرة الصالون', salary: 7000, count: 1, months: 12, nationality: 'saudi' },
                            { position: 'حلاق/مصفف أول', salary: 5000, count: 1, months: 12, nationality: 'expat' },
                            { position: 'حلاق/مصفف', salary: 4000, count: 2, months: 12, nationality: 'expat' },
                            { position: 'موظف استقبال وحجوزات', salary: 4000, count: 1, months: 12, nationality: 'saudi' }
                        ]
                    },
                    administrative: {
                        administrative: [
                    ...
                    logistics: {
                        ...
                        // صفراً هو أحد أشهر أسباب «عائد داخلي خيالي» في الدراسات.
                        logistics: [
                            { name: 'كهرباء ومياه', monthly: 2800 },
                            { name: 'مستلزمات نظافة وتعقيم', monthly: 1500 }
                        ]
                    }
                }
            }
