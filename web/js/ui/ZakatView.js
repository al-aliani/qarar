            ...
            <div class="zakat-view animate-entry">
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="table-container">
                        ...
                        <table class="data-table w-full">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        الوعاء التقريبي (صافي الربح قبل الزكاة)
                    ...
                    <div class="p-4 text-xs text-muted">
                        * تقدير مبسّط لأغراض الجدوى: الوعاء ≈ صافي الربح قبل الزكاة. الحساب النظامي الدقيق
                        (حقوق الملكية + القروض طويلة الأجل − الأصول الثابتة) يتطلب ميزانية فعلية — راجع مختصاً زكوياً قبل الإقرار.
                    </div>
                </div>
            </div>
        `;
