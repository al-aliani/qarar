 ...
 *      appSettings.mode المتبقي في المخزن من الدراسة السابقة) بدل ثابت حرفي دائماً.
 *
 * تدقيق 2026-07-18: القيمة الثابتة الافتراضية جُرِّبت مؤقتاً كـ«مصغّر»، ثم أعادها
 * المالك صراحة إلى «مفصل» — الدراسة الافتراضية يجب أن تكون كاملة (40 خطوة) ما لم
 * يختر المستخدم غير ذلك يدوياً. جوهر الاختبار (لا تسريب حالة من appSettings.mode
 * المتبقي عبر الجلسات) لم يتغيّر.
 */
