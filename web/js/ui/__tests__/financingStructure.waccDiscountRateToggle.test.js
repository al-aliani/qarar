 ...
 *
 * تدقيق 2026-08-24: خانة use-wacc-discount-rate تُفعِّل فعلياً استخدام WACC كمعدل خصم
 * NPV/IRR (bindEvents يحفظ assumptions.useWaccAsDiscountRate، وengine.js يقرأها)، لكن
 * نص wacc-disclosure كان ثابتاً يقول دوماً إن الرقم "إعلامي فقط ولا يُغذّي" معدل الخصم
 * الفعلي — أي يكذب حين تكون الخانة مفعّلة. الإصلاح: النص يتبدّل حسب حالة الخانة، حياً
 * عند تغييرها (لا فقط عند التحميل الأول).
 */
