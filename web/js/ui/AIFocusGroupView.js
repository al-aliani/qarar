            ...
            <div class="ai-focus-group-view max-w-6xl mx-auto py-8 px-4 animate-entry">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 bg-gradient-to-r from-blue-900/30 via-indigo-900/20 to-transparent p-6 rounded-2xl border border-blue-500/30 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-500 text-sm">مثال توضيحي لشكل محادثة مع عميل افتراضي — المحادثة أدناه نص ثابت لأغراض العرض فقط، وليست تفاعلاً حقيقياً مع ذكاء اصطناعي، ولا يمكن الكتابة فيها حالياً.</p>
                    </div>

                    <div class="flex items-center gap-3 relative z-10">
                        <button class="btn btn--primary !bg-blue-600 font-bold whitespace-nowrap border-0 opacity-60" style="pointer-events: none;" disabled>
                        ...
                        <div class="flex items-center gap-3 bg-black/80 px-4 py-2 rounded-xl border border-invert/5">
                            ...
                            <span class="text-xs text-invert/80 font-bold">مفهوم — قيد التطوير</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="p-6 rounded-2xl border border-blue-500/30 bg-black/80 relative overflow-hidden text-center">
                            ...
                            <div class="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 p-1 mb-4 relative">
                                ...
                                <div class="absolute bottom-0 right-0 w-6 h-6 bg-emerald-500 rounded-full border-2 border-black flex items-center justify-center">
                                    <svg class="ic w-3 h-3 text-invert" aria-hidden="true"><use href="#i-cpu"/></svg>
                                </div>
                            </div>

                            <h3 class="text-invert font-bold text-xl mb-1">سارة (العميل الافتراضي)</h3>
                            <p class="text-blue-400 text-xs font-bold mb-4">أم عاملة، 32 سنة، تسكن في الرياض</p>

                            <div class="space-y-3 text-right mt-6 border-t border-invert/10 pt-4">
                                <div class="flex justify-between text-xs">
                                    <span class="text-invert/70">الدخل الشهري</span>
                                    <span class="text-invert font-bold">12,000 - 15,000 ر.س</span>
                                </div>
                                <div class="flex justify-between text-xs">
                                    <span class="text-invert/70">الاهتمامات</span>
                                    <span class="text-invert font-bold">القهوة المختصة، السرعة، التوفير</span>
                                </div>
                                <div class="flex justify-between text-xs">
                                    <span class="text-invert/70">نقاط الألم (Pain points)</span>
                        ...
                        <!-- Mood Meter -->
                        <div class="p-6 rounded-2xl border border-invert/5 bg-black/80">
                            <h4 class="text-invert font-bold text-sm mb-4">مؤشر الإعجاب بالمنتج (مثال توضيحي)</h4>
                            <div class="relative w-full h-4 bg-black/50 rounded-full overflow-hidden mb-2">
                                ...
                                <div class="absolute top-0 right-0 h-full bg-emerald-500 mood-fill-glow rounded-full transition-all duration-1000" style="width: 75%;"></div>
                            </div>
                    ...
                    <div class="lg:col-span-2 flex flex-col h-[600px] p-4 rounded-2xl border border-indigo-500/30 bg-black/80 relative">
                        <div class="flex items-center gap-3 mb-4 pb-4 border-b border-invert/10">
                            <div class="w-2 h-2 rounded-full bg-amber-500"></div>
                            <span class="text-invert font-bold text-sm">مثال محادثة (نص ثابت — غير تفاعلي)</span>
                        </div>
                        ...
                        <div class="flex-1 overflow-y-auto space-y-4 pr-2 custom-scrollbar">
                            ...
                            <div class="flex flex-col items-start gap-1">
                                <div class="text-[10px] text-invert/70 px-2">أنت (صاحب المشروع)</div>
                                <div class="bg-indigo-600 text-invert text-sm p-3 rounded-2xl rounded-tr-sm max-w-[80%] border border-indigo-500">
                            ...
                            <div class="flex flex-col items-end gap-1">
                                ...
                                <div class="bg-invert/10 text-invert text-sm p-3 rounded-2xl rounded-tl-sm max-w-[80%] border border-invert/20 leading-relaxed text-right">
                        ...
                        <div class="mt-4 pt-4 border-t border-invert/10">
