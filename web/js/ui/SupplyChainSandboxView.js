            ...
            <div class="supply-chain-view max-w-6xl mx-auto py-8 px-4 animate-entry">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 bg-gradient-to-l from-teal-500/10 to-transparent p-6 rounded-2xl border border-teal-500/20">
                    <div>
                        ...
                        <p class="text-invert/60 text-sm">مثال توضيحي لشكل لوحة مراقبة المخزون وسلاسل الإمداد — لا يوجد اتصال فعلي حالياً بأي نظام مخزون أو شحن أو مورد حقيقي، والأرقام هنا افتراضية للتوضيح فقط.</p>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="p-6 rounded-2xl border border-teal-500/30" style="background: linear-gradient(135deg, rgba(20,184,166,0.1) 0%, rgba(0,0,0,0) 100%);">
                            <h3 class="text-invert font-bold text-sm mb-4 flex items-center gap-2">
                            ...
                            <div class="p-4 bg-black/40 border border-red-500/30 rounded-xl mb-4 relative overflow-hidden group">
                                ...
                                <p class="text-[10px] text-invert/60 mb-3">بناءً على وتيرة المبيعات الحالية (أعلى بـ 15% من المعتاد)، سينفد المخزون قريباً.</p>
                            ...
                            <div class="p-4 bg-black/40 border border-yellow-500/30 rounded-xl relative overflow-hidden">
                                ...
                                <p class="text-[10px] text-invert/60 mb-3">السفينة متأخرة 3 أيام عن الموعد المتوقع بسبب ظروف مناخية.</p>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-6 rounded-2xl relative border border-invert/5" style="background: rgba(255,255,255,0.02); min-height: 250px;">
                            <h3 class="text-invert font-bold text-sm mb-4">مثال توضيحي لمسار شحنة (لا يعكس شحنة حقيقية)</h3>

                            <div class="relative w-full h-40 mt-4 bg-black/30 rounded-xl overflow-hidden border border-invert/10">
                                ...
                                <!-- Origin (Supplier) -->
                                <div class="absolute w-8 h-8 rounded-full bg-invert/10 border border-invert/30 flex items-center justify-center left-[20px] top-[80px] -translate-x-1/2 -translate-y-1/2 text-[10px]">
                                    <svg class="ic" aria-hidden="true"><use href="#i-factory"/></svg>
                                </div>
                                <div class="absolute left-[20px] top-[100px] -translate-x-1/2 text-[10px] text-invert/50 bg-black/80 px-1 rounded">المورد (البرازيل)</div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <!-- Item -->
                            <div class="p-4 rounded-xl bg-white/5 border border-invert/10">
                                <h4 class="text-invert text-xs font-bold mb-3">حبوب بن مختصة</h4>
                                <div class="flex justify-between items-end mb-1">
                                    <span class="text-2xl font-bold text-teal-400">85%</span>
                                    <span class="text-[10px] text-invert/50">آمن</span>
                                </div>
                            ...
                            <!-- Item -->
                            <div class="p-4 rounded-xl bg-white/5 border border-invert/10">
                                <h4 class="text-invert text-xs font-bold mb-3">حليب مبستر</h4>
                                <div class="flex justify-between items-end mb-1">
                                    <span class="text-2xl font-bold text-yellow-400">40%</span>
                                    <span class="text-[10px] text-invert/50">يحتاج طلب</span>
                                </div>
                                <div class="w-full h-1.5 bg-black/50 rounded-full">
                            ...
                            <div class="p-4 rounded-xl bg-red-500/5 border border-red-500/20 relative overflow-hidden group">
                                ...
                                <h4 class="text-invert text-xs font-bold mb-3 relative z-10">أكواب ورقية</h4>
