...
export class QuickStartGuideView {
    ...
    render() {
        ...
        const steps = [
            { num: 1, title: 'اختر نقطة البداية', desc: 'من لوحة التحكم: «دراسة جديدة (كاملة)» لاستخدام القوالب القطاعية وإكمال كل الأقسام.' },
            { num: 2, title: 'أدخل بيانات المشروع', desc: 'اسم المشروع، القطاع، المدينة، وصف الفكرة.' },
        ...
        this.container.innerHTML = `
            <div class="quick-start-guide-view animate-entry p-6 max-w-2xl mx-auto" dir="rtl">
                ...
                <div class="flex flex-wrap gap-3 justify-center">
                    ${this.onStartFull ? '<button type="button" class="btn btn--primary" id="quickStartGuideFull">دراسة جديدة (كاملة)</button>' : ''}
                </div>
            </div>
        `;
