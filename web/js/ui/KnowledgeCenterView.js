...
const ARTICLES = [
    ...
    },
    {
        ...
        icon: '<svg class="ic" aria-hidden="true"><use href="#i-reset"/></svg>',
    ...
    },
    {
        ...
        icon: '<svg class="ic" aria-hidden="true"><use href="#i-clock"/></svg>',
    ...
    },
    {
        ...
        icon: '<svg class="ic" aria-hidden="true"><use href="#i-target"/></svg>',
