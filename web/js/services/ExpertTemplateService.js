...
function createSaasFeasibilityPlatformStudy() {
    ...
    data[SECTIONS.PROJECT_INFO] = {
        ...
        products: [
            { type: 'final', name: 'اشتراك أساسي', description: 'إعداد دراسة جدوى ذاتية مع حفظ المشاريع وتصدير مخرجات أولية.', uniqueFeatures: 'واجهة عربية وتدفق خطوة بخطوة — يخفض تكلفة البداية على رائد الأعمال.', customerBenefit: 'فهم جدوى الفكرة بسرعة وبأرقام قابلة للتعديل.' },
            { type: 'final', name: 'اشتراك احترافي', description: 'مؤشرات مالية متقدمة، سيناريوهات، وتقارير أعمق للمستثمر أو البنك.', uniqueFeatures: 'DSCR، NPV، IRR، حساسية وسيناريوهات — يرفع جودة القرار قبل التقديم.', customerBenefit: 'ملف أكثر تنظيماً ومصداقية.' },
            { type: 'final', name: 'قوالب مختصين معتمدة', description: 'قوالب قطاعية يضيفها مختصون مع نطاق وخبرة وسعر واضح.', uniqueFeatures: 'اسم المختص ونطاق الاعتماد ظاهر للعميل — يحوّل خبرة المختص إلى منتج قابل للبيع.', customerBenefit: 'البدء من نموذج أقرب للواقع من القوالب العامة.' }
        ],
        introServices: [
