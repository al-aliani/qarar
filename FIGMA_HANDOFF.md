...
1. **نظاما ألوان منفصلان (الأهم):** `variables.css` (التطبيق) مقابل `<style>` داخل `landing.html` (التسويق) — راجع القسمين 1 و2. أخضر التطبيق `#0e5b44` ≠ أخضر الهبوط `#0b6b4f` رغم التقارب البصري.
